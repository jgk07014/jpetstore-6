...
<table>
   ...
   한글깨짐현상으로 인해 설문지 내용 한글에서 영어로 변경-->
    ...
    <tr>
        <td>1. What is your current living environment like? <span style="color:red; font-weight:bold;">*</span></td>
        <td><stripes:select name="account.residenceEnv">
            <stripes:option value="">-- Select (Required) --</stripes:option>
            <stripes:option
                    value="Indoor-focused (apartment, studio, etc.)">Indoor-focused (apartment, studio, etc.)</stripes:option>
            <stripes:option
                    value="Includes outdoor space (yard, balcony, etc.)">Includes outdoor space (yard, balcony, etc.)</stripes:option>
            <stripes:option
                    value="Humid environment (near river/lake)">Humid environment (near river/lake)</stripes:option>
            <stripes:option value="Dry environment">Dry environment</stripes:option>
            <stripes:option
                    value="Can maintain special spaces (aquarium, terrarium, etc.)">Can maintain special spaces (aquarium, terrarium, etc.)</stripes:option>
        </stripes:select></td>
    </tr>
    <tr>
        <td>2. What is your preferred or manageable pet care period? <span style="color:red; font-weight:bold;">*</span>
        </td>
        <td><stripes:select name="account.carePeriod">
            <stripes:option value="">-- Select (Required) --</stripes:option>
    ...
    <tr>
        <td>3. What pet color best matches your living space's atmosphere or interior colors? <span
                style="color:red; font-weight:bold;">*</span></td>
        <td><stripes:select name="account.petColorPref">
            <stripes:option value="">-- Select (Required) --</stripes:option>
            <stripes:option
                    value="Light colors (white | ivory tones)">Light colors (white | ivory tones)</stripes:option>
    ...
    <tr>
        <td>4. Considering your living space and lifestyle, what pet size do you think is appropriate? <span
                style="color:red; font-weight:bold;">*</span></td>
        <td><stripes:select name="account.petSizePref">
            <stripes:option value="">-- Select (Required) --</stripes:option>
            <stripes:option
                    value="Small (suitable for studio/small apartment)">Small (suitable for studio/small apartment)</stripes:option>
            <stripes:option
                    value="Medium (regular home, some space available)">Medium (regular home, some space available)</stripes:option>
            <stripes:option
                    value="Large (yard and spacious indoor area possible)">Large (yard and spacious indoor area possible)</stripes:option>
        </stripes:select></td>
    </tr>
    <tr>
        <td>5. When are you most active? <span style="color:red; font-weight:bold;">*</span></td>
        <td><stripes:select name="account.activityTime">
            <stripes:option value="">-- Select (Required) --</stripes:option>
    ...
    <tr>
        <td>6. When managing your pet's diet, what level of care can you provide? <span
                style="color:red; font-weight:bold;">*</span></td>
        <td><stripes:select name="account.dietManagement">
            <stripes:option value="">-- Select (Required) --</stripes:option>
            <stripes:option
                    value="Simple kibble-focused (carnivore, omnivore)">Simple kibble-focused (carnivore, omnivore)</stripes:option>
            <stripes:option
                    value="Can provide diverse diet (vegetarian, mixed possible)">Can provide diverse diet (vegetarian, mixed possible)</stripes:option>
            <stripes:option
                    value="Can manage special diets (insect-based, dried food, etc.)">Can manage special diets (insect-based, dried food, etc.)</stripes:option>
        </stripes:select></td>
    </tr>
